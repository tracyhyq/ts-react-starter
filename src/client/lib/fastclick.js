...
(function() {
  ...
  //11.3.0 版本号
  //11,3,0
  function isIosEqual(first, second, third) {
    if (!ioSversion) {
      return false;
    }
    if (
  ...
  FastClick.prototype.focus = function(targetElement) {
    ...
    //https://github.com/framework7io/framework7/issues/2314#issuecomment-377778034
    ...
    if (
      ...
      if (isIosEqual(11, 3) || isIosEqual(11, 4)) {
        //https://github.com/ftlabs/fastclick/issues/548
        targetElement && targetElement.focus && targetElement.focus();
      }
  ...
  FastClick.prototype.onTouchStart = function(event) {
    ...
    if (this.isUsingEventTimeStamp && event.timeStamp > -1) {
      ...
      if (this.isUsingEventTimeStamp) {
        ...
        this.nonEventTrackingTimeBase =
          new Date().getTime() - this.tapDelay * 2;
        this.lastClickTime = 0;
  ...
  FastClick.prototype.onTouchEnd = function(event) {
    ...
    if (targetTagName === 'label') {
      ...
      if (
        touchEndTime - trackingClickStart > 100 ||
